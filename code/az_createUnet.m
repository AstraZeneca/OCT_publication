function lgraph = az_createUnet(inputTileSize, noClasses)
...
finalConv = convolution2dLayer(1,noClasses,...
    'BiasL2Factor',0,...
    'Name','Final-ConvolutionLayer');

finalConv.Weights = randn(1,1,decoderNumChannels,noClasses);
finalConv.Bias = randn(1,1,noClasses)*0.00001 + 1;
