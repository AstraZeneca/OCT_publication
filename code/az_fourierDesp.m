function finalMask = az_fourierDesp(i_binaryMask, i_percentBound)
...
%         end;
        ...
        if nargin <= 1
            numBound = uint16(real(sqrt(boundLength))-10);
        else
            numBound = boundLength * i_percentBound;
        end
        
        zz = q_ifrdescp_GW(z, numBound);
